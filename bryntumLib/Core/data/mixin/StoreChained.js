...
export default Target => class StoreChained extends (Target || Base) {
     ...
     * @param {Object} [config] Additional chained store configuration. See {@link Core.data.Store#configs}
    ...
    makeChained(chainedFilterFn = returnTrue, chainedFields, config) {
        ...
        return new (config?.storeClass || this.constructor)(Object.assign(config || {}, {
            tree        : false,
            autoTree    : false,
            masterStore : this,
