...
export default class DateHelper extends Localizable() {
     ...
     * @param {String} [options.precision] The minimum precision unit.
     * @param {Boolean} [options.ignoreLocale] Pass true to return unlocalized unit name. Requries `abbrev` to be false.
     ...
     * @param {Number|String|Core.data.Duration|Object} amount Amount of days, hours etc. or a string representation of a duration
     ...
     * @returns {Object} If successfully parsed, the result contains two properties, `magnitude` being a number, and
