...
export default class ViewPresetHeaderRow {
     ...
     * @config {'millisecond'|'second'|'minute'|'hour'|'day'|'week'|'month'|'quarter'|'year'} unit
     */
     ...
     * @param {'start'|'center'|'end'} [headerConfig.align] The text alignment for the cell. See
     * {@link #config-align} config.
     * @param {String} [headerConfig.headerCellCls] A CSS class to add to the cells in the time axis header row. See
     * {@link #config-headerCellCls} config.
